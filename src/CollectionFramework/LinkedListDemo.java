...
//All methods of Array list implementation will be applicable in Linked List
	public static void main(String[] args) {
		 ...
		 LinkedList<Object> arr3 = new LinkedList<Object>();
		arr.add(100);
		arr.add(20);
		arr.add(20);
		arr.add("pankaj");
		arr.add('A');
		arr.add('p');
		arr.addFirst("Apple");//Linked list specific methods
		arr.addLast("Orange");//Linked list specific methods
	

		System.out.println(arr);
		arr.removeFirst();//Linked list specific methods
		arr.removeLast();//Linked list specific methods
		System.out.println(arr);
